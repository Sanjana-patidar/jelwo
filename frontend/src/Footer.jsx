        ...
        <div data-aos="fade-up" class="container-section footer ">
             <div class="row pt-5 pb-5 border-bottom">
                <div class="col-12 col-sm-6 col-md-4 mb-3 m-sm-0">
                    <div>
                        <img class="w-25" src="img/logo.avif" alt=""/>
                ...
                <div class="col-12 col-sm-6 col-md-3 mb-3 m-sm-0">
                    <div>
                        <h5 data-aos="fade-up">Opening time</h5>
             ...
             <div data-aos="flip-left" data-aos-duration="2000" className='second-footer pt-5 pb-5 ' >
                    <ul class="list-unstyled order-list">
                     <li class="ftlist">
                        ...
                        <ul class="list-unstyled list-item">
                            ...
                            <li><Link to='/faqpage'className='text-decoration-none text-secondary' >Faq's</Link></li>
                    ...
                    <li class="ftlist">
                        <div class="d-none d-sm-block">
                            <h3 >Contact us</h3>
                        <ul class="list-unstyled">
                            <li>55 East 10th street,Ahemdabad, ry 10003, Gujrat</li>
                            <li> <i class="fa-solid fa-phone text-danger"></i> +(220)123 456 7890</li>
                            <li><i class="fa-solid fa-envelope text-danger"></i> sanjana@345@gmail.com</li>
                        </ul>
                        </div>
                        {/* small screen collapse */}
                        <div class="d-block d-sm-none">
                        <div class="d-flex justify-content-between ps-2 pe-2">
                         ...
                         <Collapse in={open3}>
                                <ul id="example-collapse-text" className='list-unstyled pe-2 ps-2' >
                                      <li>55 East 10th street,new york, ry 10003, united states</li>
                                      <li> <i class="fa-solid fa-phone text-danger"></i> +(220)123 456 7890</li>
                                      <li><i class="fa-solid fa-envelope text-danger"></i> demo@123456@gmail.com</li>
                                </ul> 
                        </Collapse>                         
                     </div>
                    </li>
